"""This is the Mutitaper LS module.

This computes the Multitaper LS periodogram using
...
def mtls_spec(t, x, NW=4.0, K=7, tapers=None, center_data=False,
             nyquist_factor=1, adaptive_weighting=False,
             niterations=100):
    '''
